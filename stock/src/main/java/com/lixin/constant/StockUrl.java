...
public class StockUrl {
    ...
    public static String xq_day_K_scode_tcode = "https://stock.xueqiu.com/v5/stock/chart/kline.json?symbol={}&begin={}&period=day&type=before&count=-32&indicator=kline,pe,pb,ps,pcf,market_capital,agt,ggt,balance";
